    ...
    return (
        <div>
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Edit Publikasi</h1>
                </div>
            </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="w-4 h-4 text-hipmi-green border-gray-300 rounded"
                        />
                        <label htmlFor="published" className="text-sm font-medium text-gray-700">Publikasikan</label>
                    </div>
                </div>
