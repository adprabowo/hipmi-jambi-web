        ...
        <div className="container mx-auto px-4">
            ...
            <div className="space-y-4">
                {newsArticles.slice(0, 3).map((news) => (
                    <div key={news.id} className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:shadow-md transition">
                        <div>
                            ...
                            <h3 className="text-lg font-bold text-gray-900">
                                <Link href={`/berita/${news.slug}`} className="hover:text-hipmi-green transition">
                                    {news.title}
                                </Link>
                            </h3>
                            <p className="text-sm text-gray-500">{news.date}</p>
                        </div>
                        <Link href={`/berita/${news.slug}`} className="flex-shrink-0 px-4 py-2 border border-gray-300 text-gray-600 rounded-lg text-sm font-medium hover:bg-gray-50 transition">
                            Baca Rilis
                        </Link>
                    </div>
                ))}
