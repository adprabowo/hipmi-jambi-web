...
export default function NewsCard({ title, date, category, excerpt, slug, index, image }: NewsProps) {
  return (
    <div className="group flex flex-col bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full">
      ...
      <div className={`h-48 w-full relative overflow-hidden flex items-center justify-center text-white ${index % 2 === 0
        ...
        {/* Badge Kategori */}
        <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-hipmi-green text-xs font-bold px-3 py-1 rounded-full flex items-center shadow-sm z-10">
